...
#[function_component]
pub fn FeedbackItems(props: &Props) -> Html {
    ...
    let on_delete = {
        ...
        Callback::from(move |_: MouseEvent| {
            ...
            let confirmed = confirm_delete("Do you really want to delete this feedback?");
    ...
    html! {
        <div class="bg-white text-gray-700 rounded-lg p-8 my-5 relative">
            <div class="bg-ping-500 text-white rounded-full border-2 border-gray-200 w-12 h-12 flex items-center justify-center text-2xl font-bold absolute top-0 left-0 -mt-4 -ml-4">
