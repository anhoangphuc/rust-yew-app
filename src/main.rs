        ...
        <>
            if show_alert {
               <AlertComponent
                ...
                if *loading {
                    <div class="fixed top-5 left-5 inline-block h-8 w-8 animate-spin rounded-full border-4 border-yellow border-r-transparent align-[-0.125em] text-warning motion-reduce:animate[spin_1.5s_linear_infinite]"
                        role="status">
